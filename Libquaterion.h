...
public://1
	quaterion(double a = 1, double b = 0, double c = 0, double d = 0);
	quaterion(const quaterion& q);
	~quaterion();

public://2
	void set_quaterion(double a, double b, double c, double d);

public://3
	void get_quaterion(double& a, double& b, double& c, double& d);
